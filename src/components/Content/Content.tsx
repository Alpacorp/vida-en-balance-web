...
export const Content: FC<ContentProps> = ({ title, description, image, types }) => {
  ...
  return (
      <div ref={divRef} className="bg-gray-50">
            ...
            <div className="grid grid-cols-1 items-center gap-x-16 gap-y-10 lg:grid-cols-2">
              <div>
                ...
                <div className="mt-5 flex gap-1">
                  <button
                      type="button"
                      className="inline-flex items-center rounded-md bg-amber-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-amber-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-400"
                  >
                    Información nutrimental
                  </button>
                  <button
                      type="button"
                      className="inline-flex items-center rounded-md bg-blue-500 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-blue-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700"
                  >
                    Recetas
                  </button>
                </div>
                    ...
                    {types?.map((type) => (
                        <div key={type.id} className="sm:flex flex-col h-1/2 items-center justify-center">
                          <div className="sm:shrink-0">
                            <img alt={type.name} src={type.url} className="h-auto w-28 aspect-auto" />
                          </div>
