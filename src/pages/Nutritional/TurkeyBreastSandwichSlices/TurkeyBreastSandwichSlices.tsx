...
import { nutritionalInfo, presentations, ingredients } from "@content/nutritional/TurkeyBreastSandwichSlices.json";

import { Product } from "@interfaces/interfaces";

export const TurkeyBreastSandwichSlices = () => {
  const [activeProduct, setActiveProduct] = useState<Product>(products[3]);
