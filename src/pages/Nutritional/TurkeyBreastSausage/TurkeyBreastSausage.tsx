...
import { nutritionalInfo, presentations, ingredients } from "@content/nutritional/TurkeyBreastSausage.json";

import { Product } from "@interfaces/interfaces";

export const TurkeyBreastSausage = () => {
  const [activeProduct, setActiveProduct] = useState<Product>(products[4]);
