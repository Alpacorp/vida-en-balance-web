export const balanceContent = {
  "cuerpo-en-balance": {
    ...
    seo: {
      ...
      description:
        "Descubre consejos y técnicas para mantener tu cuerpo en perfecto equilibrio con Balance.",
  ...
  "mente-en-balance": {
    ...
    seo: {
      ...
      description:
        "Aprende técnicas de mindfulness y meditación para mantener tu mente en balance.",
  ...
  "tips-balance": {
    ...
    seo: {
      ...
      description:
        "Descubre consejos prácticos para mantener un equilibrio en todos los aspectos de tu vida.",
    ...
    articles: [
      {
        title: "21K juntos",
        description:
          "Descubre cómo prepararte para una carrera de 21 kilómetros.",
        imageUrl: "/assets/images/carrera-blog.webp",
        imageAlt: "Pareja corriendo",
      ...
      },
      {
        ...
        imageUrl: "/assets/images/lesiones-blog.webp",
        imageAlt: "Una pareja haciendo ejercicio",
        ctaText: "Conoce más",
      ...
      },
      {
        ...
        imageUrl: "/assets/images/tratamiento-blog.webp",
        imageAlt: "Pareja feliz hablando",
        ctaText: "Conoce más",
